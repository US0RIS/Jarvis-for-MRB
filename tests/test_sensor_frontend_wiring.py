...
class AmbientFrontendContractTests(unittest.TestCase):
    def test_opt_in_defaults_off_and_privacy_mode_revokes_consent(self) -> None:
        settings = (_ROOT / "ios/JarvisIOS/SettingsStore.swift").read_text(encoding="utf-8")
        local = (_ROOT / "ios/JarvisIOS/LocalPowerFeatures.swift").read_text(encoding="utf-8")
        settings_view = (_ROOT / "ios/JarvisIOS/SettingsView.swift").read_text(encoding="utf-8")
    ...
    def test_presence_uses_existing_microphone_and_separately_timestamped_gps(self) -> None:
        ...
        sound = (_ROOT / "ios/JarvisIOS/LocalAudioMemory.swift").read_text(encoding="utf-8")
        ...
        self.assertIn('snapshot.get("enabled")', (_ROOT / "jarvis_mrb/sensor_opportunities.py").read_text(encoding="utf-8"))
    ...
    def test_idle_sound_capture_yields_microphone_to_voice_meetings_and_tts(self) -> None:
        audio = (_ROOT / "ios/JarvisIOS/LocalAudioMemory.swift").read_text(encoding="utf-8")
        frontend = (_ROOT / "ios/JarvisIOS/FrontendIntelligence.swift").read_text(encoding="utf-8")
        speech = (_ROOT / "ios/JarvisIOS/SpeechRecognizer.swift").read_text(encoding="utf-8")
        tts = (_ROOT / "ios/JarvisIOS/SpeechSynthesizer.swift").read_text(encoding="utf-8")
        meeting = (_ROOT / "ios/JarvisIOS/MainView.swift").read_text(encoding="utf-8")
    ...
    def test_physical_actions_are_individually_preapproved_and_verified(self) -> None:
        ...
        self.assertNotIn("runPreapprovedArrivalActions()", (_ROOT / "jarvis_mrb/sensor_opportunities.py").read_text(encoding="utf-8"))
    ...
    def test_backend_transient_sensor_state_never_mirrors_raw_snapshot(self) -> None:
        ...
        service = (_ROOT / "jarvis_mrb/service.py").read_text(encoding="utf-8")
