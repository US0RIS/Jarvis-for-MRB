...
class MeshCoordinatorTests(unittest.TestCase):
    ...
    def test_phone_ui_privacy_source_and_no_os_remote_control(self):
        ...
        self.assertIn('Menu("Open an exact app on this device")', ui)
        ...
        self.assertIn('JARVIS_MESH_WINDOWS_APP_ENABLED', (ROOT / "jarvis_mrb/mesh_windows_apps.py").read_text())
        self.assertIn('launch_exact_windows_app(request.app_name)', (ROOT / "jarvis_mrb/service.py").read_text())
        self.assertIn('node.id == "windows"', ui)
