...
TOOL_RISK: dict[str, Risk] = {
    ...
    "web.search": "read",
    "vision.recall": "read",
    "vision.ocr_clipboard": "local_write",
    "expense.capture": "local_write",
    "expense.list": "read",
    "expense.export": "local_write",
    "fact.check": "read",
    "journal.generate": "local_write",
    "meeting.start": "local_write",
    "meeting.append": "local_write",
    "meeting.finish": "local_write",
    "meeting.list": "read",
    "jobs.list": "read",
