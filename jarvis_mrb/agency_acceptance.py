...
def _bind_isolated_world(base: Path) -> dict[str, Any]:
    ...
    world_executive.DB_PATH = db
    desired_state.DB_PATH = db
    agency_plan.DB_PATH = db
    agency_runtime.DB_PATH = db
    agency_attention.DB_PATH = db
    agency_capability.DB_PATH = db
    agency_counterfactual.DB_PATH = db
    agency_deliberation.DB_PATH = db
    agency_self_model.DB_PATH = db
    world_verification.DB_PATH = db
